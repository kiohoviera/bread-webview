                        ...
                        <div class="card">
                          ...
                          <span class="app-brand-logo">
                              <span class="app-brand-text demo menu-text fw-bold">Scanner </span>
                                ...
                                <div class="mb-3">
                                    <h5>Status <button type="button" class="btn btn-sm btn-success waves-effect waves-light">On</button> </h5>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="bread_info" type="text" class="form-control" name="bread_info" readonly value="" />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Manufacturing Date</label>
                                        <input id="manufacturing_date" type="date" class="form-control" name="manufacturing_date" readonly />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Expiration Date</label>
                                        <input id="expiration_date" type="date" class="form-control" name="expiration_date" readonly />
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Quantity</label>
                                        <input id="quantity" type="number" class="form-control" name="quantity" readonly />
                                    </div>
